...
export default function InputFormModal1({ isOpen, onClose, initialData}) {
  ...
  useEffect(() => {
    console.log('📝 InputFormModal1 received initialData:', initialData);
    ...
    console.log('✅ Expense form fields updated:', {
      to: initialData.to,
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center ">
      ...
      >
        ...
        {/* <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg text-xs">
